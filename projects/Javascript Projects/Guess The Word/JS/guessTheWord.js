...
/*-------------------------------STEPS------------------------------*/
//category - catch the element in html and then innerHTML - done !

//divs - create them in js to sync the letters of each word 

//catch the keyboard with the classlist and that way we can get each key separately

/*the keyboard has three steps, the first one is 
if the word includes the letter the users clicks on it goes straight to the div (innerHTML) , the secod step is if the letter is incorrect then it goes down to the incorrect letters div and the third one is consume a heart with each failed attempt*/

/*for the CLUE we do an add event listener because it will be hidden at first and if the user clicks on the hint button it will be displayed on the screen*/

/*restart game button => add event listener on it to start the game 
